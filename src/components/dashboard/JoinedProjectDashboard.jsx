...
const JoinedProjectDashboard = () => {
  ...
  return (
    <DashboardContainer>
      <DrawerHeader />
      <MainTitle variant="h5">Project Participant Dashboard</MainTitle>
      <DashboardGrid>
        ...
        <DashboardCard to="project-team" state={{ projectId }}>
          <DashboardIcon>
            <Groups color="black" />
          </DashboardIcon>
          <DashboardTitle>Project Team</DashboardTitle>
        </DashboardCard>
...
export default JoinedProjectDashboard;
